<template>
  <div class="flex justify-between mt-20 xl:mx-32 2xl:mx-40 3xl:mx-20">
    <ButtonHeader v-for="(item, index) in menuHeaders" 
    :key="index" 
    :item="item"/>
  </div>
</template>
...
<script setup>
  ...
  const menuHeaders = [
    ...
    { name: "Хот-доги", icon: new URL('../assets/img/icons/Хот-доги.svg', import.meta.url).href },
